...
import org.example.Pages_WebElements.P08_FollowUs_WebElements;
...
public class D08_FollowUs_StepDefinitions {
    ...
    public void facebookPage() throws InterruptedException {
        ...
        String actualResult = driver.switchTo().window(tabs.get(1)).getCurrentUrl(); // كدة انا بقوله هات تاني تاب واضغط عليه وهات اللينك بتاعه
